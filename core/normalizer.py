from adapters import normalize_agentur, normalize_arbeitnow, normalize_remotive,normalize_jobicy, normalize_arbeitnow_list, normalize_agentur_list, normalize_remotive_list, normalize_jobicy_list
